...
protection_counts=conservation_counts_fixed.sort_values('scientific_name')
protection_counts
...
ax=plt.subplot()
xvalues=range(len(protection_counts.scientific_name))
plt.bar(xvalues,protection_counts.scientific_name)
...
ax=plt.subplot()
xvalues2=range(len(obs_by_park.observations))
plt.bar(xvalues2,obs_by_park.observations)
ax.set_xticks(xvalues2)
